...
func (x *AwsTicket) VDLRead(dec vdl.Decoder) error {
	*x = AwsTicket{}
	...
	for {
		...
		switch index {
		case 0:
			if err := dec.StartValue(__VDLType_optional_9); err != nil {
				return err
			}
			if dec.IsNil() {
...
func (x *TlsServerTicket) VDLRead(dec vdl.Decoder) error {
	*x = TlsServerTicket{}
	...
	for {
		...
		switch index {
		case 0:
			if err := dec.StartValue(__VDLType_optional_15); err != nil {
				return err
			}
			if dec.IsNil() {
...
func (x *VanadiumTicket) VDLRead(dec vdl.Decoder) error {
	*x = VanadiumTicket{}
	...
	for {
		...
		switch index {
		case 0:
			if err := dec.StartValue(__VDLType_optional_23); err != nil {
				return err
			}
			if dec.IsNil() {
...
func (x GenericTicket) VDLWrite(enc vdl.Encoder) error {
	...
	if len(x.Data) != 0 {
		if err := enc.NextFieldValueBytes(0, __VDLType_list_25, x.Data); err != nil {
			return err
		}
	}
	if err := enc.NextField(-1); err != nil {
...
func (x TicketEcrTicket) Index() int                 { return 2 }
...
func (x TicketTlsServerTicket) Index() int                 { return 3 }
...
func (x TicketTlsClientTicket) Index() int                 { return 4 }
...
func (x TicketDockerTicket) Index() int                 { return 5 }
...
func (x TicketDockerServerTicket) Index() int                 { return 6 }
...
func (x TicketDockerClientTicket) Index() int                 { return 7 }
...
func (x TicketB2Ticket) Index() int                 { return 8 }
...
func (x TicketVanadiumTicket) Index() int                 { return 9 }
...
func (x TicketGenericTicket) Index() int                 { return 10 }
...
func (x Config) VDLWrite(enc vdl.Encoder) error {
	...
	if len(x.Tickets) != 0 {
		...
		if err := __VDLWriteAnon_map_2(enc, x.Tickets); err != nil {
			return err
		}
	}
	if len(x.Permissions) != 0 {
...
func __VDLWriteAnon_map_2(enc vdl.Encoder, x map[string]TicketConfig) error {
...
func (x *Config) VDLRead(dec vdl.Decoder) error {
	*x = Config{}
	...
	for {
		...
		switch index {
		case 0:
			if err := __VDLReadAnon_map_2(dec, &x.Tickets); err != nil {
				return err
			}
		case 1:
			if err := x.Permissions.VDLRead(dec); err != nil {
...
func __VDLReadAnon_map_2(dec vdl.Decoder, x *map[string]TicketConfig) error {
...
var (
	...
	__VDLType_optional_15 *vdl.Type
...
func __VDLInit() struct{} {
	...
	__VDLType_struct_6 = vdl.TypeOf((*B2AccountAuthorizationBuilder)(nil)).Elem()
	__VDLType_struct_7 = vdl.TypeOf((*VanadiumBuilder)(nil)).Elem()
	__VDLType_struct_8 = vdl.TypeOf((*AwsTicket)(nil)).Elem()
	__VDLType_optional_9 = vdl.TypeOf((*AwsAssumeRoleBuilder)(nil))
	__VDLType_optional_10 = vdl.TypeOf((*AwsSessionBuilder)(nil))
	__VDLType_struct_11 = vdl.TypeOf((*S3Ticket)(nil)).Elem()
	__VDLType_struct_12 = vdl.TypeOf((*EcrTicket)(nil)).Elem()
	__VDLType_struct_13 = vdl.TypeOf((*TlsCredentials)(nil)).Elem()
	__VDLType_struct_14 = vdl.TypeOf((*TlsServerTicket)(nil)).Elem()
	__VDLType_optional_15 = vdl.TypeOf((*TlsCertAuthorityBuilder)(nil))
	__VDLType_struct_16 = vdl.TypeOf((*TlsClientTicket)(nil)).Elem()
	__VDLType_struct_17 = vdl.TypeOf((*DockerTicket)(nil)).Elem()
	__VDLType_struct_18 = vdl.TypeOf((*DockerServerTicket)(nil)).Elem()
	__VDLType_struct_19 = vdl.TypeOf((*DockerClientTicket)(nil)).Elem()
	__VDLType_struct_20 = vdl.TypeOf((*B2Ticket)(nil)).Elem()
	__VDLType_optional_21 = vdl.TypeOf((*B2AccountAuthorizationBuilder)(nil))
	__VDLType_struct_22 = vdl.TypeOf((*VanadiumTicket)(nil)).Elem()
	__VDLType_optional_23 = vdl.TypeOf((*VanadiumBuilder)(nil))
	__VDLType_struct_24 = vdl.TypeOf((*GenericTicket)(nil)).Elem()
	__VDLType_list_25 = vdl.TypeOf((*[]byte)(nil))
	__VDLType_union_26 = vdl.TypeOf((*Ticket)(nil))
	__VDLType_struct_27 = vdl.TypeOf((*TicketConfig)(nil)).Elem()
	__VDLType_map_28 = vdl.TypeOf((*access.Permissions)(nil))
	__VDLType_struct_29 = vdl.TypeOf((*Config)(nil)).Elem()
	__VDLType_map_30 = vdl.TypeOf((*map[string]TicketConfig)(nil))
