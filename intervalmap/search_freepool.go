// Code generated from " ../gtl/generate.py --prefix=searcher -DELEM=*searcher --package=intervalmap --output=search_freepool.go ../gtl/randomized_freepool.go.tpl ". DO NOT EDIT.
