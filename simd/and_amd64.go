// Code generated from " ../gtl/generate.py --prefix=And -DOPCHAR=& --package=simd --output=and_amd64.go bitwise_amd64.go.tpl ". DO NOT EDIT.
...
// AndUnsafeInplace sets main[pos] := arg[pos] & main[pos] for every position
// in main[].
//
...
// AndInplace sets main[pos] := arg[pos] & main[pos] for every position in
