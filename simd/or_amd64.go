// Code generated from " ../gtl/generate.py --prefix=Or -DOPCHAR=| --package=simd --output=or_amd64.go bitwise_amd64.go.tpl ". DO NOT EDIT.
...
// OrUnsafeInplace sets main[pos] := arg[pos] | main[pos] for every position
// in main[].
//
